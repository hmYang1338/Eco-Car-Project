	...
	<section class="bg-primary" id="about">
		...
		<div class="content-wrapper">
			...
			<div class="container-fluid" style="padding-top: 5%; padding-left: 10%; padding-right: 10%; padding-bottom: 5%">
				...
				<br>
				<div>
				<p>검색어를 입력하세요<input type="image" src="img/gps-icon.svg" 
				style="float:right; width: 35px; height: 35px;" onclick="searchGPS()" ></p>
				
				</div>
				<!-- 검색 -->
				<input class="w3-input" id="stationSearch" type="text" value="" oninput="searchWords(this.value)">
		...
		function searchGPS() {
			...
			if (navigator.geolocation) {
				navigator.geolocation.getCurrentPosition(function(position) {
					sendRequest("SearchGPS","latitude="+position.coords.latitude+
							"&longitude="+position.coords.longitude, viewWords, "POST");
				}, function(error) {
					console.error(error);
				}, {
